...
const EditProfilePage = () => {
  return (
    <div>
        <HeaderSection title="Create Collection" category='Home /' subtitle='Create Collection'/>
        <div className='flex flex-col md:flex-row md:px-10 justify-center'>

        <div className='mt-10 md:w-1/3 px-10 flex flex-col'>
          <div className='flex flex-col gap-2'>
            <p className='font-bold'>Upload NFT Avatar</p>
            <p className='font-light text-sm text-slate-400'>Drag or choose your file to upload</p>
            <Button className='border-[2px] border-purple rounded-full text-purple hover:text-purple cursor-pointer mt-2 '>Upload New Photo</Button>
          </div>
        </div>
