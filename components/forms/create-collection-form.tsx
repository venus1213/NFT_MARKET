...
import { Clock4, Info, Tag, Users2 } from "lucide-react"
...
<FormField
              ...
              <FormControl>
                ...
                >
                  <FormItem className="flex items-center  space-y-0">
                    ...
                    <FormLabel className="bg-slate-100 rounded-xl border-transparent     hover:border-[2px] active:border-[2px] hover:border-purple active:border-purple p-4">
                      <div className="flex justify-center pb-2"><Tag size="20"/></div>
                      Fixed&nbsp;Rate
                    </FormLabel>
                  </FormItem>
                  ...
                  <FormItem className="flex items-center space-x-3 space-y-0">
                    ...
                    <FormLabel className="bg-slate-100 rounded-xl border-transparent     hover:border-[2px] active:border-[2px] hover:border-purple active:border-purple p-4">
                    <div className="flex justify-center pb-2"><Users2 size="20"/></div>
                      Open&nbsp;For&nbsp;Bids</FormLabel>
                  </FormItem>
                  ...
                  <FormItem className="flex items-center space-x-3 space-y-0">
                    ...
                    <FormLabel className="bg-slate-100 rounded-xl border-transparent     hover:border-[2px] active:border-[2px] hover:border-purple active:border-purple p-4">
                    <div className="flex justify-center pb-2"><Clock4 size="20"/></div>
                      Time&nbsp;Auction
                    </FormLabel>
                  </FormItem>
                </RadioGroup>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>Collection Title<span className="text-purple">*</span></FormLabel>
              <FormControl className="bg-slate-100 rounded-xl border-transparent     hover:border-[2px] active:border-[2px] hover:border-purple active:border-purple p-5">
                <Input className="text-slate-400" placeholder="e.g: Cult Bears DAO" {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
          ...
          render={({ field }) => (
            ...
            <FormLabel>Description <span className="text-purple">*</span></FormLabel>
              <FormControl className="bg-slate-100 rounded-xl border-transparent     hover:border-[2px] active:border-[2px] hover:border-purple active:border-purple p-10">
                <Input className="text-slate-400" placeholder="e.g: An omnichain web3 movement of bears" {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
...
/> 
        ...
        <Button className="text-semibold bg-purple hover:bg-purple text-white rounded-full px-6" type="submit">Create Collection</Button>
      </form>
    </Form>
  )
}
